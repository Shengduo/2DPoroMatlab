function poro_run_regularized_cluster2(in_mass, Gamma, cc)
    ...
    NS = 100; %gets changed, just to initialize and allowcate imperfectly
    NSplot = 10;
        ...
        while tryagain || enter
            ...
            if tryagain == 0
                ...
                if isnan(sum(V))
                    ...
                    filename = strcat('P_hold_Original','_gamma_', num2str(gamma),...
                    ...
                    txtname = strcat('P_hold_Original','_gamma_', num2str(gamma),...
