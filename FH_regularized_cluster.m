function FH_regularized_cluster(Nuu, Gamma, cc)
    ...
    for it = 2:NT
        ...
        while tryagain || enter
            ...
            % If Vg small, use explicit scheme
                ...
                % Regularized friction law
                % V = 2 * Vr * sinh((tau - eta * Vg(I)) ./ (si) ./ a) ./ exp((fr + b .* log(Vr * thetag / L)) ./ a);
            ...
            if tryagain == 0
                ...
                if isnan(sum(V))
                    ...
                    filename = strcat('FH_nuu_', num2str(nuu), '_gamma_', num2str(gamma),...
                    ...
                    txtname = strcat('FH_nuu_', num2str(nuu), '_gamma_', num2str(gamma),...
