function Regularized_cluster_diffusion_factors_flux_control_1010(Nuu, Gamma, cc,...
        ...
        while tryagain || enter
            ...
            if tryagain == 0
                ...
                if isnan(sum(V))
                    ...
                    filename = strcat('../outputMats/', 'FluxTime_', num2str(flux), '_1010_NewFH_', num2str(FHFlag), '_nuu_',  num2str(nuu), '_gamma_', num2str(gamma),...
                    ...
                    txtname = strcat('../outputMats/', 'FluxTime_', num2str(flux), '_1010_NewFH_', num2str(FHFlag), '_nuu_',  num2str(nuu), '_gamma_', num2str(gamma),...
                                      '_pflag_', num2str(poreflag),'_c_', num2str(cc), '_factors_', ...
                                      num2str(factors(1)), '_', num2str(factors(2)), '_',num2str(factors(3)),'.mat');
