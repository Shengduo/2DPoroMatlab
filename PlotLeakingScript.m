...
clc,clear;
close all;
filenames = ["FH_0_nuu_0.35_gamma_0_pflag_3_c_4e-07_factor_1", ...         % 68
...
title('Injected fluid mass $\gamma=0$', 'interpreter', 'latex');    
...
savename = strcat(pwd, '/../dsvg_plots1/', 'CumMassAll.png');
disp(savename);
