function poro_run_regularized_cluster1(in_mass, Gamma, cc)
        ...
        while tryagain || enter
            ...
            if tryagain == 0
                ...
                if isnan(sum(V))
                    ...
                    filename = strcat('P_hold_Reduced','_gamma_', num2str(gamma),...
                    ...
                    txtname = strcat('P_hold_Reduced','_gamma_', num2str(gamma),...
