function Regularized_cluster_new_0827(Gamma, FHFlag, poreflag, kappa_cx, prefix)
    %% factors: 
    ...
    %material parameters, CHANGED TO WESTERLY GRANITE-20230827
    nu = 0.25;
    nuu = 0.34;
    B = 0.85;
    G = 15e9;
    ...
    L_nu = G * L / (b - a) / si0;
    kappac = 8.7584e-17;  % e-20 : cy = 2e-10, we want e-7 here
        ...
        while tryagain || enter
            ...
            if tryagain == 0
                ...
                if isnan(sum(V))
                    ...
                    filename = strcat('../outputMats/', prefix, '_gamma_', num2str(gamma),...
                                      '_pflag_', num2str(poreflag), '_kappacx_', num2str(kappacx), '.mat');
                    ...
                    txtname = strcat('../outputMats/', prefix, '_gamma_', num2str(gamma),...
                                      '_pflag_', num2str(poreflag), '_kappacx_', num2str(kappacx), '.txt');
