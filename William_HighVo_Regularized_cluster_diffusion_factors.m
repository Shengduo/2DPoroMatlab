function William_Regularized_cluster_diffusion_factors(Nuu, Gamma, cc, FHFlag, poreflag, factors, verticalFlag)
        ...
        while tryagain || enter
            ...
            if tryagain == 0
                ...
                if isnan(sum(V))
                    ...
                    filename = strcat('../outputMats/', 'William_HighVo_NewFH_verticalFlag_', num2str(verticalFlag), '_', num2str(FHFlag), '_nuu_',  num2str(nuu), '_gamma_', num2str(gamma),...
                    ...
                    txtname = strcat('../outputMats/', 'William_HighVo_NewFH_verticalFlag_', num2str(FHFlag), '_', num2str(FHFlag), '_nuu_',  num2str(nuu), '_gamma_', num2str(gamma),...
                                      '_pflag_', num2str(poreflag),'_c_', num2str(cc), '_factors_', ...
                                      num2str(factors(1)), '_', num2str(factors(2)), '_',num2str(factors(3)),'.mat');
    ...
    % Write changable parameters into a '.txt' file
    txtname = strcat('../outputMats/', 'William_HighVo_NewFH_verticalFlag_', num2str(verticalFlag), '_', num2str(FHFlag), '_nuu_',  num2str(nuu), '_gamma_', num2str(gamma),...
                      '_pflag_', num2str(poreflag),'_c_', num2str(cc), '_factors_', ...
